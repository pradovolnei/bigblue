          ...
          <div class="col-md-12 ">
			...
			<a href="#" data-widget="collapse" style="text-decoration:none;color:#000;">
              <div class="card-header" style="background-color:#48D1CC;">
                <h6 class="card-title">Atendimento - <?php echo str_pad($row["id"] , 6 , '0' , STR_PAD_LEFT);?></h6>
              </div>
			</a>
              <div class="card-body">
                <!-- Minimal style -->
						...
						<div class="form-group">
						  ...
						  <?php 
							...
							while($cols = mysqli_fetch_array($exec_exames)){
								echo $cols["exame"]." <a href='laudo.php?e=".base64_encode($cols["codigo"])."&p=".base64_encode($row["id"])."' target='_blank'><img class='pdf' src='dist/img/pdf.png' /></a><br>";
								if($perfil_usuario == 4 || $perfil_usuario == 1){
									echo "<a href='#'><button class='btn btn-block btn-primary btn-sm add-mobile'  data-toggle='modal' data-target='#result".$row["id"]."_".$cols["codigo"]."'>Informar Resultado</button></a>";
									}
									
							?>
							
							<form action="" method="post" enctype="multipart/form-data" >
				<div class="modal fade" id="result<?php echo $row["id"]; ?>_<?php echo $cols["codigo"]; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				  <div class="modal-dialog" role="document">
					<div class="modal-content">
					  <div class="modal-header">
						<h5 class="modal-title" id="exampleModalLabel">Resultado Exame </h5>
					  ...
					  <div class="modal-body">
						<div class="form-group">
						  ...
						  <input type="hidden" name="exame" value="<?php echo $cols["codigo"]; ?>" />
						</div>
